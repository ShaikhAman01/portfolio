    ...
    >
      <code className="block select-text w-full">
        ...
        <motion.div variants={line} className="pl-4 sm:pl-8 flex flex-wrap items-start row-gap-0">
          ...
          <span className="text-emerald-600 dark:text-emerald-400 break-all sm:break-normal">'{profile.name}'<span className="text-zinc-400 dark:text-zinc-500">,</span></span>
        </motion.div>
